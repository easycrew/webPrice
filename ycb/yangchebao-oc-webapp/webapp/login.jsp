...
<div class="container-fluid" id="main-container">
	<div id="main-content">
		<div class="row-fluid">
								...
								<div class="widget-body">
									<div class="widget-main">
										<div class="login-form">
											<h2 class="header lighter  blue"><span class="logo"></span><span>车网互联运营内容管理系统</span></h2>
											<form>
												<fieldset>
													<label>
													...
													<label>
														<span class="block input-icon input-icon-right">
															...
															<img src="/euc/ws/0.1/captcha" alt="验证码" title="点击图片刷新验证码" style="margin:-5px 5px 5px;" align="absmiddle" id="captchimg" class="captcha-img" onclick="index.refreshCaptchaImg('captchimg');return false;" /></span> 
														</span>
            ...
            <div class="span12" id="foot">
                <p>©2015 北京车盈科技有限公司&nbsp;版权所有&nbsp;京ICP备15056241号-1</p>
            </div>
		</div>
	</div>
</div> 
    ...
    $(window).bind("load", function() {
        ...
        function positionFooter() {
            ...
            if(($(document.body).height()+footerHeight) < $(window).height()) {
                $("#foot").css({ position: "absolute",left:"0" }).stop().css({top:footerTop});
            }
        }
