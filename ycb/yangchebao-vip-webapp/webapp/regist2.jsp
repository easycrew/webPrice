	...
	<div class="container">
		...
		<div class="content">
			<div class="regist">
				...
				<div class="step-content" style="background-color:#fff;padding:10px 0;">
					<div class="step-pane active" id="step1">
						<p style='margin-left:3%;font-size:1.2em;'>注册的手机号、密码即为登陆商家后台的账号及密码。</p>
					...
					<div class="step-pane" id="step2">
						...
						<div class="grid-row-fluid">
							...
							<div class="span15 ui-note">
								...
								<div style="overflow:hidden;margin-left:107px;margin-bottom:10px;">
				...
				<div class="wizard-actions">
					...
					<button class="btn btn-small btn-primary btn-next"  last-data="下一步">
							下一步，店铺信息认证
			...
			if(info.step==1){ 
				...
				if(agree.length==0){ 
						...
						$.jRadPost({
						   ...
						   success:function(){
							 flag = true;
							 $(".wizard-actions .btn-next").html('下一步<i class="icon-arrow-right icon-on-right"></i>')
						   },
						   error:function(xhr){
				...
				if(info.direction == 'previous'){
					$(".wizard-actions .btn-next").html('下一步，店铺信息认证<i class="icon-arrow-right icon-on-right"></i>');
				}
				if(info.direction == 'next'){
...
document.write(unescape("%3Cscript src='" + _bdhmProtocol + "hm.baidu.com/h.js%3Ff924926d1eaf998748c11fd77a92f7ca' type='text/javascript'%3E%3C/script%3E"));
</script>
